...
class S {
  ...
  String get onlyUprightReading {
    return Intl.message(
      'Only Upright Cards?',
      name: 'onlyUprightReading',
      desc: '',
      args: [],
    );
  }
  ...
  String get tutorialMinorWands {
    return Intl.message(
      'Wands',
      name: 'tutorialMinorWands',
      desc: '',
      args: [],
    );
  }

  String get tutorialMinorCups {
    return Intl.message(
      'Cups',
      name: 'tutorialMinorCups',
      desc: '',
      args: [],
    );
  }

  String get tutorialMinorPentacles {
    return Intl.message(
      'Pentacles',
      name: 'tutorialMinorPentacles',
      desc: '',
      args: [],
    );
  }

  String get tutorialMinorSwords {
    return Intl.message(
      'Swords',
      name: 'tutorialMinorSwords',
      desc: '',
      args: [],
    );
  }
